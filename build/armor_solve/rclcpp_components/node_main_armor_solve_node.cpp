...
#define NODE_MAIN_LOGGER_NAME "armor_solve_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libarmor_solve.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<rm_auto_aim::ArmorSolveNode>";
