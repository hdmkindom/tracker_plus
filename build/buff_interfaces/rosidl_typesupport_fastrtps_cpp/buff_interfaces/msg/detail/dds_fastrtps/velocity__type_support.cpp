...
#include "buff_interfaces/msg/detail/velocity__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const buff_interfaces::msg::Velocity & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  buff_interfaces::msg::Velocity & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = buff_interfaces::msg::Velocity;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const buff_interfaces::msg::Velocity *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<buff_interfaces::msg::Velocity *>(
    untyped_ros_message);
...
{
  return &buff_interfaces::msg::typesupport_fastrtps_cpp::_Velocity__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, buff_interfaces, msg, Velocity)() {
  return &buff_interfaces::msg::typesupport_fastrtps_cpp::_Velocity__handle;
}
