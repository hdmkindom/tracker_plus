...
#include "buff_interfaces/msg/detail/velocity__rosidl_typesupport_fastrtps_c.h"
...
using _Velocity__ros_msg_type = buff_interfaces__msg__Velocity;
...
size_t get_serialized_size_buff_interfaces__msg__Velocity(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Velocity__ros_msg_type * ros_message = static_cast<const _Velocity__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Velocity__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_buff_interfaces__msg__Velocity(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_buff_interfaces
size_t max_serialized_size_buff_interfaces__msg__Velocity(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = buff_interfaces__msg__Velocity;
    is_plain =
      (
...
static size_t _Velocity__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_buff_interfaces__msg__Velocity(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, buff_interfaces, msg, Velocity)() {
