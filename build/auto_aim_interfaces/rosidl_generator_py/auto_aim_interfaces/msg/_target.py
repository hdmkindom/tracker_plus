...
class Target(metaclass=Metaclass_Target):
    ...
    def __init__(self, **kwargs):
        ...
        self.a_yaw = kwargs.get('a_yaw', float())
        self.aa_yaw = kwargs.get('aa_yaw', float())
        self.radius_1 = kwargs.get('radius_1', float())
        self.radius_2 = kwargs.get('radius_2', float())
        self.dz = kwargs.get('dz', float())
        self.v_yaw_rpm = kwargs.get('v_yaw_rpm', float())
        self.v_yaw_degree = kwargs.get('v_yaw_degree', float())
    ...
    def __eq__(self, other):
        ...
        if self.dz != other.dz:
            return False
        if self.v_yaw_rpm != other.v_yaw_rpm:
            return False
        if self.v_yaw_degree != other.v_yaw_degree:
            return False
        return True
    ...
    @a_yaw.setter
    def a_yaw(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'a_yaw' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'a_yaw' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._a_yaw = value

    @builtins.property
    def aa_yaw(self):
        """Message field 'aa_yaw'."""
        return self._aa_yaw

    @aa_yaw.setter
    def aa_yaw(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'aa_yaw' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'aa_yaw' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._aa_yaw = value
    ...
    @builtins.property
    def v_yaw_rpm(self):
        """Message field 'v_yaw_rpm'."""
        return self._v_yaw_rpm

    @v_yaw_rpm.setter
    def v_yaw_rpm(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'v_yaw_rpm' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'v_yaw_rpm' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._v_yaw_rpm = value

    @builtins.property
    def v_yaw_degree(self):
        """Message field 'v_yaw_degree'."""
        return self._v_yaw_degree

    @v_yaw_degree.setter
    def v_yaw_degree(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'v_yaw_degree' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'v_yaw_degree' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._v_yaw_degree = value
