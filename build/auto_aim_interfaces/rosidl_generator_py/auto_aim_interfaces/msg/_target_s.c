...
bool auto_aim_interfaces__msg__target__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // a_yaw
    PyObject * field = PyObject_GetAttrString(_pymsg, "a_yaw");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->a_yaw = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // aa_yaw
    PyObject * field = PyObject_GetAttrString(_pymsg, "aa_yaw");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->aa_yaw = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // radius_1
  ...
  {  // v_yaw_rpm
    PyObject * field = PyObject_GetAttrString(_pymsg, "v_yaw_rpm");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->v_yaw_rpm = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // v_yaw_degree
    PyObject * field = PyObject_GetAttrString(_pymsg, "v_yaw_degree");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->v_yaw_degree = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * auto_aim_interfaces__msg__target__convert_to_py(void * raw_ros_message)
{
  ...
  {  // a_yaw
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->a_yaw);
    {
      int rc = PyObject_SetAttrString(_pymessage, "a_yaw", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // aa_yaw
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->aa_yaw);
    {
      int rc = PyObject_SetAttrString(_pymessage, "aa_yaw", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // v_yaw_rpm
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->v_yaw_rpm);
    {
      int rc = PyObject_SetAttrString(_pymessage, "v_yaw_rpm", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // v_yaw_degree
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->v_yaw_degree);
    {
      int rc = PyObject_SetAttrString(_pymessage, "v_yaw_degree", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
