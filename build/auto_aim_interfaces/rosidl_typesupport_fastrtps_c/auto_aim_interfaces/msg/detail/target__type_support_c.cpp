  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: a_yaw
  {
    cdr << ros_message->a_yaw;
  }

  // Field name: aa_yaw
  {
    cdr << ros_message->aa_yaw;
  }
  ...
  // Field name: v_yaw_rpm
  {
    cdr << ros_message->v_yaw_rpm;
  }

  // Field name: v_yaw_degree
  {
    cdr << ros_message->v_yaw_degree;
  }
  ...
  size_t current_alignment)
{
  ...
  // field.name a_yaw
  {
    size_t item_size = sizeof(ros_message->a_yaw);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name aa_yaw
  {
    size_t item_size = sizeof(ros_message->aa_yaw);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name radius_1
  ...
  // field.name v_yaw_rpm
  {
    size_t item_size = sizeof(ros_message->v_yaw_rpm);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name v_yaw_degree
  {
    size_t item_size = sizeof(ros_message->v_yaw_degree);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    is_plain =
      (
      offsetof(DataType, v_yaw_degree) +
      last_member_size
      ) == ret_val;
  }
