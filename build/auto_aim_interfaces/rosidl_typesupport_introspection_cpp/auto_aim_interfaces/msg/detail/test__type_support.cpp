...
{
  new (message_memory) auto_aim_interfaces::msg::Test(_init);
}

void Test_fini_function(void * message_memory)
{
  auto typed_message = static_cast<auto_aim_interfaces::msg::Test *>(message_memory);
  typed_message->~Test();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Test_message_member_array[3] = {
  {
    ...
    offsetof(auto_aim_interfaces::msg::Test, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(auto_aim_interfaces::msg::Test, yaw),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(auto_aim_interfaces::msg::Test, d_yaw),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Test_message_members = {
  ...
  "Test",  // message name
  3,  // number of fields
  sizeof(auto_aim_interfaces::msg::Test),
...
get_message_type_support_handle<auto_aim_interfaces::msg::Test>()
{
  return &::auto_aim_interfaces::msg::rosidl_typesupport_introspection_cpp::Test_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, auto_aim_interfaces, msg, Test)() {
  return &::auto_aim_interfaces::msg::rosidl_typesupport_introspection_cpp::Test_message_type_support_handle;
}
