...
auto_aim_interfaces__msg__Target__are_equal(const auto_aim_interfaces__msg__Target * lhs, const auto_aim_interfaces__msg__Target * rhs)
{
  ...
  // a_yaw
  if (lhs->a_yaw != rhs->a_yaw) {
    return false;
  }
  // aa_yaw
  if (lhs->aa_yaw != rhs->aa_yaw) {
    return false;
  }
  // radius_1
  ...
  // v_yaw_rpm
  if (lhs->v_yaw_rpm != rhs->v_yaw_rpm) {
    return false;
  }
  // v_yaw_degree
  if (lhs->v_yaw_degree != rhs->v_yaw_degree) {
    return false;
  }
  return true;
}
  ...
  auto_aim_interfaces__msg__Target * output)
{
  ...
  // a_yaw
  output->a_yaw = input->a_yaw;
  // aa_yaw
  output->aa_yaw = input->aa_yaw;
  // radius_1
  ...
  output->dz = input->dz;
  // v_yaw_rpm
  output->v_yaw_rpm = input->v_yaw_rpm;
  // v_yaw_degree
  output->v_yaw_degree = input->v_yaw_degree;
  return true;
}
