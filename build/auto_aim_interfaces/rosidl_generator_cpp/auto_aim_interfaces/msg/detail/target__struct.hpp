...
struct Target_
{
  ...
  using _dz_type =
    double;
  _dz_type dz;
  using _v_yaw_rpm_type =
    double;
  _v_yaw_rpm_type v_yaw_rpm;
  using _v_yaw_degree_type =
    double;
  _v_yaw_degree_type v_yaw_degree;
  ...
  Type & set__v_yaw_degree(
    const double & _arg)
  {
    this->v_yaw_degree = _arg;
    return *this;
  }
  ...
  bool operator==(const Target_ & other) const
  {
    ...
    if (this->a_yaw != other.a_yaw) {
      return false;
    }
    if (this->aa_yaw != other.aa_yaw) {
      return false;
    }
    ...
    if (this->v_yaw_rpm != other.v_yaw_rpm) {
      return false;
    }
    if (this->v_yaw_degree != other.v_yaw_degree) {
      return false;
    }
    return true;
  }
