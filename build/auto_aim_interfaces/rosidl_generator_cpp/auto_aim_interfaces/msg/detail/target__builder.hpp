...
class Init_Target_v_yaw_degree
{
public:
  explicit Init_Target_v_yaw_degree(::auto_aim_interfaces::msg::Target & msg)
  : msg_(msg)
  {}
  ::auto_aim_interfaces::msg::Target v_yaw_degree(::auto_aim_interfaces::msg::Target::_v_yaw_degree_type arg)
  {
    msg_.v_yaw_degree = std::move(arg);
...
class Init_Target_v_yaw_rpm
{
public:
  explicit Init_Target_v_yaw_rpm(::auto_aim_interfaces::msg::Target & msg)
  : msg_(msg)
  {}
  Init_Target_v_yaw_degree v_yaw_rpm(::auto_aim_interfaces::msg::Target::_v_yaw_rpm_type arg)
  {
    msg_.v_yaw_rpm = std::move(arg);
    return Init_Target_v_yaw_degree(msg_);
  }
...
public:
  ...
  : msg_(msg)
  {}
  Init_Target_v_yaw_rpm dz(::auto_aim_interfaces::msg::Target::_dz_type arg)
  {
    msg_.dz = std::move(arg);
    return Init_Target_v_yaw_rpm(msg_);
  }
...
class Init_Target_aa_yaw
{
public:
  explicit Init_Target_aa_yaw(::auto_aim_interfaces::msg::Target & msg)
  : msg_(msg)
  {}
  Init_Target_radius_1 aa_yaw(::auto_aim_interfaces::msg::Target::_aa_yaw_type arg)
  {
    msg_.aa_yaw = std::move(arg);
...
class Init_Target_a_yaw
{
public:
  explicit Init_Target_a_yaw(::auto_aim_interfaces::msg::Target & msg)
  : msg_(msg)
  {}
  Init_Target_aa_yaw a_yaw(::auto_aim_interfaces::msg::Target::_a_yaw_type arg)
  {
    msg_.a_yaw = std::move(arg);
    return Init_Target_aa_yaw(msg_);
  }
...
public:
  ...
  : msg_(msg)
  {}
  Init_Target_a_yaw v_yaw(::auto_aim_interfaces::msg::Target::_v_yaw_type arg)
  {
    msg_.v_yaw = std::move(arg);
    return Init_Target_a_yaw(msg_);
  }
