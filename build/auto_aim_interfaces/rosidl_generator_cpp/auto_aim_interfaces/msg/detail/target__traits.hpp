  ...
  std::ostream & out)
{
  ...
  {
    out << "a_yaw: ";
    rosidl_generator_traits::value_to_yaml(msg.a_yaw, out);
    out << ", ";
  }
  ...
  {
    out << "aa_yaw: ";
    rosidl_generator_traits::value_to_yaml(msg.aa_yaw, out);
    out << ", ";
  }
  ...
  {
    out << "v_yaw_rpm: ";
    rosidl_generator_traits::value_to_yaml(msg.v_yaw_rpm, out);
    out << ", ";
  }
  ...
  {
    out << "v_yaw_degree: ";
    rosidl_generator_traits::value_to_yaml(msg.v_yaw_degree, out);
  }
  out << "}";
