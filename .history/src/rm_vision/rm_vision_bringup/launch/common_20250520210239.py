...
armor_solve_node = Node(
    package='armor_solve',
    executable='armor_solve_node',
    output='both',
    emulate_tty=True,
    parameters=[node_params],
    ros_arguments=['--log-level', 'armor_solve:='+launch_params['armor_solve_log_level']],
)

buff_solve_node = Node(
    package='buff_solve',
    executable='buff_solve_node',
    output='both',
    emulate_tty=True,
    parameters=[node_params],
    ros_arguments=['--log-level', 'armor_solve:='+launch_params['buff_solve_log_level']],
)
