...
def generate_launch_description():
    ...
    from common import node_params, launch_params, robot_state_publisher, armor_tracker_node, armor_solve_node, buff_tracker_node, auto_record_node
    ...
    delay_armor_solve_node = TimerAction(
        period=2.5,
        actions=[armor_solve_node]
    )
    ...
    # delay_buff_solve_node = TimerAction(
    # period=3.0,
