...
void RecordNode::recordInit(std_msgs::msg::String::SharedPtr msg)
{
  if (msg->data == "start" && record_state_ == WAIT) {
    ...
    armor_sub_ = create_subscription<auto_aim_interfaces::msg::Armors>(
      topic_info_[2].topic_name, rclcpp::SensorDataQoS(),
      [this](std::shared_ptr<rclcpp::SerializedMessage> msg) { write(msg, 2); });
