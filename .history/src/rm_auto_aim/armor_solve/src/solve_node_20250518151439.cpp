...
: Node("armor_solve", options)
{
    ...
    detector_latency_sub_ = this->create_subscription<auto_aim_interfaces::msg::AllLatency>(
    ...
    // /tracker/latency
    // tracker_latency_sub_ = this->create_subscription<auto_aim_interfaces::msg::AllLatency>(
    //     "/detector/Latency", rclcpp::QoS(rclcpp::QoSInitialization::from_rmw(rmw_qos_profile_sensor_data)),
    //     std::bind(&ArmorSolveNode::detectorLatencyCallback, this, std::placeholders::_1));
...
void ArmorSolveNode::detectorLatencyCallback(const auto_aim_interfaces::msg::AllLatency::SharedPtr detector_latency)
{
