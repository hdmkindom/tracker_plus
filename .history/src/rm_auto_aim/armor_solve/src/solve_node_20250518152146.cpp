...
void ArmorSolveNode::detectorLatencyCallback(const auto_aim_interfaces::msg::DetectorLatency::SharedPtr detector_latency)
{
    det_latency = detector_latency->detector_latency;
}

void ArmorSolveNode::trackerLatencyCallback(const auto_aim_interfaces::msg::TrackerLatency::SharedPtr tracker_latency)
{
    det_latency = tracker_latency->detector_latency;
}
