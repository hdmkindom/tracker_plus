...
: Node("armor_solve", options)
{
    ...
    // 用于弹道解算的k值具体计算在git
    k = this->declare_parameter("solve.k", 0.038);
    ...
    fire_k = this->declare_parameter("solve.fire_k", 0.001);
    ...
    aim_point_marker_.ns = "armors";
    aim_point_marker_.action = visualization_msgs::msg::Marker::ADD;
    aim_point_marker_.type = visualization_msgs::msg::Marker::CUBE;
    aim_point_marker_.scale.x = 0.05;
    aim_point_marker_.scale.z = 0.125;
    aim_point_marker_.color.a = 1.0;
    aim_point_marker_.color.g = 0.5;
    aim_point_marker_.color.b = 1.0;
    aim_point_marker_.lifetime = rclcpp::Duration::from_seconds(0.5);
}
...
void ArmorSolveNode::targetCallback(const auto_aim_interfaces::msg::Target::SharedPtr target_msg)
{
    ...
    solve_info_msg.header.stamp = time;
    ...
    solve_info_msg.aim_x = aim_x;
    solve_info_msg.aim_y = aim_y;
    solve_info_msg.aim_z = aim_z;
