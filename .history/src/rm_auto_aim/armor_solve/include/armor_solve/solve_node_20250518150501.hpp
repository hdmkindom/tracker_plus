...
private:
    ...
    void detectorLatencyCallback(const auto_aim_interfaces::msg::AllLatency::SharedPtr detector_latency);
    ...
    rclcpp::Subscription<auto_aim_interfaces::msg::AllLatency>::SharedPtr detector_latency_sub_;
