...
#include <auto_aim_interfaces/msg/detail/detctor_latency__struct.hpp>
...
: Node("armor_detector", options)
{
  ...
  detector_latency_pub_ = 
    this->create_publisher<auto_aim_interfaces::msg::DetctorLatency>("/detector/Latency", 
...
void ArmorDetectorNode::imageCallback(const sensor_msgs::msg::Image::ConstSharedPtr img_msg)
{
  ...
  auto_aim_interfaces::msg::DetctorLatency latency_msg;
