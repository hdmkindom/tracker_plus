...
//     detector_latency_sub_ = this->create_subscription<buff_interfaces::msg::DetectorLatency>(
...
//     tracker_latency_sub_ = this->create_subscription<buff_interfaces::msg::TrackerLatency>(
