...
: Node("buff_solve", options)
{
    ...
    blade_array_sub_ = this->create_subscription<buff_interfaces::msg::BladeArray>(
        ...
        std::bind(&BuffSolveNode::bladesCallback, this, std::placeholders::_1));
    ...
    tf2_filter_->registerCallback(&BuffSolveNode::bladesCallback, this);
}
...
void BuffSolveNode::bladesCallback(
